...
class PlayerInterface {
 ...
 public:
  ...
  static bool isValidPlayerID(const PlayerID player) {
    return player < getMaxPlayers() && player != INVALID_PLAYER_ID;
  }
  ...
  static PlayerID getMaxPlayers() { return max_players; }
  ...
  static PlayerID getLocalPlayerIndex() { return local_player_index; }
  ...
  static bool testRulePlayerRespawn(bool *completed,
                                    PlayerState **player_state);
