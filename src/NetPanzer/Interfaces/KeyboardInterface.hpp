...
class KeyboardInterface {
 ...
 public:
  static void sampleKeyboard() { previous_key_state = key_table; }
  ...
  static bool getKeyPressed(int scanCode) {
    return !textmode && KeyboardInterface::getKeyState(scanCode) &&
  ...
  static inline void flushCharBuffer() { char_buffer.clear(); }
   ...
   */
  static inline void setTextMode(bool enabled) { textmode = enabled; }
  ...
  static inline void putChar(int c) { char_buffer.push_back(c); }
};
