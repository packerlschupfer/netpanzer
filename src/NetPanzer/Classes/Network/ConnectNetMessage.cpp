...
Uint8 ClientConnectJoinRequest::getNMode() const { return Uint8(n_mode); }

void ClientConnectJoinRequest::setNMode(Uint8 nm) { n_mode = Uint8(nm); }
...
void ClientConnectJoinRequestAck::setServerProtocolVersion(
...
Uint8 ConnectClientSettings::getNStatus() const { return Uint8(nstatus); }

void ConnectClientSettings::setNStatus(Uint8 ns) { nstatus = Uint8(ns); }
