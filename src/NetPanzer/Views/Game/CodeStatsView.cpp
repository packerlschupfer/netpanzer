...
static void buttonNetwork(void) { display_mode = _display_mode_network_stats; }

static void buttonSorter(void) { display_mode = _display_mode_sorter_stats; }

static void buttonPathing(void) { display_mode = _display_mode_pathing_stats; }

static void buttonUnit(void) { display_mode = _display_mode_unit_stats; }

static void bNetLog(void) { NetworkState::logNetworkStats(); }
...
CodeStatsView::CodeStatsView() : GameTemplateView() {
  ...
  addButtonCenterText(iXY(0, INFO_AREA_Y_OFFSET), bXOffset, "Net", "",
                      buttonNetwork);
  addButtonCenterText(iXY(bXOffset, INFO_AREA_Y_OFFSET), bXOffset, "Sprite", "",
                      buttonSorter);
  addButtonCenterText(iXY(bXOffset * 2, INFO_AREA_Y_OFFSET), bXOffset, "Unit",
                      "", buttonUnit);

  INFO_AREA_Y_OFFSET += 18;
  addButtonCenterText(iXY(0, INFO_AREA_Y_OFFSET), area_size.x, "Path", "",
                      buttonPathing);
