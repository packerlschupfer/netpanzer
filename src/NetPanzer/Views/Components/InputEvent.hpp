...
class InputEvent {
 protected:
  ...
  int modifiers;   // The modifier keys down during the event (shift, ctrl, alt,
                   // meta).
 ...
 public:
  ...
  inline int isControlDown() { return modifiers & CTRL_MASK; }
  inline int isMetaDown() { return modifiers & META_MASK; }
  inline int isAltDown() { return modifiers & ALT_MASK; }
  inline int isAltGraphDown() { return modifiers & ALT_GRAPH_MASK; }
  inline TimeStamp getWhen() const { return when; }
