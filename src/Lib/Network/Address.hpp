...
class Address {
 public:
  enum A_STATUS { ST_ERROR, ST_UNRESOLVED, ST_WAITING, ST_RESOLVING, ST_OK };
  ...
  static Address resolve(const std::string& name, unsigned short port,
                         bool isTcp = true, bool forBinding = false);
