...
class ColorTable {
 ...
 public:
  ...
  inline int getColorCount() { return colorCount; }
  inline const Uint8 *getColorArray() { return colorArray; }

  static int getTotalColorArrayCount() { return totalColorArrayCount; }
  static int getTotalByteCount() { return totalByteCount; }

  void create(const int color1Percent, const int color2Percent,
              const char *filename);
  void createTrans0(const int &color1Percent, const int &color2Percent,
                    const char *filename);
